...
Suppose host A sends host B one TCP segment with sequence number `400`, acknowledgement number `360` , and `4` bytes of data. Then the sequence number in the acknowledgement to this segment is **`360`**.
